 ...
 */
@AllArgsConstructor
public class EzyClientWsRunnerTest {
    ...
    private static String getErrorMessage() {
    		return "Usage: " + EzyClientWsRunnerTest.class.getSimpleName() + " <host> <port>";
    }
    
    public static Logger getLogger() {
    		return LoggerFactory.getLogger(EzyClientWsRunnerTest.class);
    }
