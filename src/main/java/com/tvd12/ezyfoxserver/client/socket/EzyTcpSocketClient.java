...
public class EzyTcpSocketClient
    ...
    private EzyResponseApi newResponseApi() {
        ...
        EzyMessageDataEncoder socketDataEncoder = new EzySimpleSocketDataEncoder(encoder);
    ...
    private EzySocketDataHandler newSocketDataHandler() {
        ...
        EzyMessageDataDecoder socketDataDecoder = new EzySimpleSocketDataDecoder(decoder);
